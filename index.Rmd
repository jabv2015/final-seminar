...
???
+ Inequality plays a secondary role in the design of economic policy compared to efficiency measures such as Economic Growth
+ The above is reflected in:
  - justifications to delay reforms
  - data availability

+ Extant literature has documented a link between (**consequences of**) inequality and:
...
+ **Causes of income inequality** include **Globalization** (Milanovic, 2016), **Skill-biased technological change** (Tinbergen, 1975), investment in **human capital** (Murphy & Topel, 2016), **Institutions**, **redistributive policy** and **country-specific characteristics** (Acemoglu, 1995, 2002; Acemoglu et al., 2001a, 2001c)
...
+ Using **spatial models**  (cross-sectional and panel) to find the spatial structure that best fits the clustering process of income inequality after controlling for other variables
...
### First Stage (DEA): [Inputs - Output](#inputs-outputs-summary) used to measure LGE  
...
<img src="images/ES_animation.gif" alt="drawing" width="600"/>
...
- Modelling spatial dependence-heterogeneity in LGE and use of alternatives IV´s.
...
- Predictive analylitics (Machine Learning?) for the probability to get an eficient performance.
...
class: center
name: poisson
#### Results: [Poisson](#interpretation) Regression
